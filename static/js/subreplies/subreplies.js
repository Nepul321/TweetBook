...
const form = document.getElementById("sub-reply-create-form")
...
function DeleteReply(id) {
    const method = "DELETE";
    const endpoint = `/api/subreplies/${id}/`;
    const xhr = new XMLHttpRequest();
...
function likeUnlikeReply(id, action) {
    const endpoint = "/api/subreplies/like-unlike/";
...
form.addEventListener('submit', (e) => {
    ...
    const endpoint = "/api/subreplies/create/"
    const method = "POST"
    const xhr = new XMLHttpRequest();
    xhr.open(method, endpoint)
    xhr.onload = () => {
